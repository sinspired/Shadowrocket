...
>
#### `使用必看：`<br>
> 你所使用的节点，**尽量包含`香港节点`，`美国节点`，`新加坡节点`这三项**；<br>
> 如不完全包含这三个地区的节点，则需要自行修改代理分组/正则，或使用`精简配置`；<br>
> 
> 本配置默认规则如下：<br>
> 国内应用直接连接；<br>
...
>
#### `模块说明：`<br>
> 由`向晚`基于`墨鱼去开屏`与`奶思去广告`定制，可去除常见应用的开屏广告，及部分应用的内置广告，由生成器每日自动构建；<br>
...
> **特别警告：本模块不做任何“解锁”等相关支持，如果侵权，请联系本人移除，谢谢！**<br>
>
#### `融合说明：`<br>
##### `功能模块：`<br>
...
> [*皮皮虾(fmz200)*](https://raw.githubusercontent.com/XiangwanGuan/Shadowrocket/main/Rewrite/Pipixia.conf.conf)<br>

...
开启`自动后台更新`，间隔选择`7`；<br>
> 设置-GeoLite2数据库：
长按后拷贝对应链接：[Country](https://raw.githubusercontent.com/Loyalsoldier/geoip/release/Country-only-cn-private.mmdb) & [ASN](https://raw.githubusercontent.com/Loyalsoldier/geoip/release/Country-asn.mmdb)，粘贴至**对应区域**的`URL`位置，点击`更新`；<br>
> 设置-排除路由0.0.0.0/31：
选择`关闭`；<br>

...
> **融合模块内置基于[奶思规则合集](https://github.com/fmz200/wool_scripts/blob/main/Loon/rule/rejectAd.list)修改的[分流规则](https://github.com/XiangwanGuan/Shadowrocket/blob/main/Rules/RejectAD.list)，由于部分原因，暂时作为去广告的补充规则；**<br>

...
>
#### `模块说明：`<br>
> 由[向晚](https://github.com/XiangwanGuan/Shadowrocket)基于[奶思](https://github.com/fmz200/wool_scripts/raw/main/QuantumultX/rewrite/chongxie.txt)的合集定制，融合部分其他功能，可支持五百余款应用或小程序的净化，详情参见`融合说明`；<br>

...
"""
    ...
    sgmodule_content += f"""
[Script]
AMDC.js =type=http-response, pattern=^http:\/\/amdc\.m\.taobao\.com, script-path=https://raw.githubusercontent.com/XiangwanGuan/Shadowrocket/main/Rewrite/AbortAMDC.js, requires-body=true, max-size=-1
